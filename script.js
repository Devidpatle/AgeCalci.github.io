...
btn.addEventListener('click',(days,month, year) => {
    ...
    if(daysH.value == "" || monthH.value == "" || yearH.value == ""){
         return alert("Please enter your Date of Birth proprly to calculate your age");
         //no else condition needed
    }
    console.log('Current Date: ${d} ${m} ${y}');
    // we need some day numbers as we have different number of days for different month
    if (m==1){//january
        maxDays = 31;
        monthNum = 1;    
    }
    ...
    console.log('Your age is ${ageYear} y, ${ageMonths} m and ${ageDays}d');
    showAge.innerHTML = 'Your age is ${yearH} ,${monthH} and ${DaysH}';
